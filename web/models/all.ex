defmodule Isucon5q.User do
  ...
  # Generate passhash from password and salt strings
  # This function returns the same value of `SHA2(CONCAT(password, salt))` that is generated by SQL.
  #
  # NOTE: Another way (ref: https://gist.github.com/10nin/5713366 )
  #   :crypto.hash(:sha512, password <> salt)
  #   |> :erlang.bitstring_to_list
  #   |> Enum.map(&(:io_lib.format("~2.16.0b", [&1])))
  #   |> List.flatten
  #   |> :erlang.list_to_bitstring
  def gen_passhash(password, salt) do
    :crypto.hash(:sha512, password <> salt)
    |> Base.encode16
    |> String.downcase
  end
